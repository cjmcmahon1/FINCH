...
base_folder = '../Images/Bench_Images/4-6-22/';
%tuned crop parameters to center the images
crop1 = [1 1080 1 1440];
%open images
im1 = open_im(strcat(base_folder, 'noph-0deg.png'));
im2 = open_im(strcat(base_folder, 'noph-60deg.png'));
im3 = open_im(strcat(base_folder, 'noph-120deg.png'));
...
if flag_gen_3dhol
    ...
    z_vals = linspace(-100, 100, 50); %focus seems to be ~-8mm
