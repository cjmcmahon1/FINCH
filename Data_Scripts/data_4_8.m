...
base_folder = '../Images/Bench_Images/4-8-22/';
%tuned crop parameters to center the images
crop1 = [100 900 320 1020];
%open images
im1 = open_im(strcat(base_folder, '75um-0deg.png'));
im2 = open_im(strcat(base_folder, '75um-60deg.png'));
im3 = open_im(strcat(base_folder, '75um-120deg.png'));
